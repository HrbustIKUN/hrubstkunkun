<template>
  <div class="app-container">
    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-form-item>
        <el-input v-model="clerkQueryVo.email" placeholder="邮箱地址" />
      </el-form-item>
      <el-form-item>
        <el-input v-model="clerkQueryVo.skills" placeholder="专业技能" />
      </el-form-item>
      <el-form-item>
        <el-select v-model="clerkQueryVo.sex" placeholder="性别" clearable>
    ...
    >
        ...
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            ...
            <el-form-item label="专业技能">
              <span>{{ props.row.skills }}</span>
            </el-form-item>
            <br />
            <el-form-item label="入职时间">
              <span>{{ props.row.gmtCreate ? new Date(props.row.gmtCreate).toLocaleDateString() : '' }}</span>
            </el-form-item>
            <br />
      ...
      <el-table-column prop="id" sortable label="员工编号" width="180" />
      ...
      <el-table-column
        ...
        width="100"
      />
      <el-table-column prop="skills" label="专业技能" min-width="180" show-overflow-tooltip />
      <el-table-column prop="gmtCreate" label="入职时间" width="120">
        <template slot-scope="scope">
          {{ scope.row.gmtCreate ? new Date(scope.row.gmtCreate).toLocaleDateString() : '' }}
        </template>
      </el-table-column>
      <el-table-column label="操作" width="200" align="center">
        <template slot-scope="scope">
          <router-link :to="'/permissions/updateClerk/' + scope.row.id">
