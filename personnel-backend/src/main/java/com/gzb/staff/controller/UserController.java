...
import com.gzb.staff.entity.vo.UserInfoVo;
...
public class UserController {
    ...
    public R info(@RequestParam("token") String token){
        ...
        if (!StringUtils.isEmpty(byId)) {
            ...
            return R.ok().data("roles",roles).data("introduction",userInfoVo.getIntroduction()).data("avatar",userInfoVo.getAvatar()).data("name",userInfoVo.getName()).data("userId",byId.getId());
        } else {
