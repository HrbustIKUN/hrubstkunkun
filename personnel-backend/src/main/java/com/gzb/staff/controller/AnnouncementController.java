...
import com.gzb.staff.entity.Announcement;
import com.gzb.staff.service.AnnouncementService;
...
public class AnnouncementController {
    ...
    public R getAnnouncementList() {
        List<Announcement> announcementList = announcementService.list((Wrapper<Announcement>) null);
    ...
    public R numInfo(){
        ...
        SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");//设置日期格式
        announcementQueryWrapper.le("time",df.format(new Date()));
        long annCount = announcementService.count(announcementQueryWrapper);
        long clerkCount = clerkService.count(null);
        long attendanceCount = attendanceService.count(null);
        long rewardsPunishmentsCount = rewardsPunishmentsService.count(null);
        return R.ok()
